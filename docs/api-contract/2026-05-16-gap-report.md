# API Contract Gap Report — 2026-05-16

## Summary

- Backend operations: 82
- Frontend operations: 82
- Backend snapshot: `logs/api-contract-2026-05-16/backend-openapi.normalised.json`
- Frontend snapshot: `logs/api-contract-2026-05-16/frontend-openapi.json`
...
- Intermediate artefacts: `logs/api-contract-2026-05-16/` (git-ignored).
